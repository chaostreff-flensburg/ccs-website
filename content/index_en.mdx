...
<div class="homeContent">
  <h1 class="text-center" id="headline">Scholarships - 2024/2025.Winter</h1>
  <p class="text-center">The "Chaotic Catalyst Scholarships #CCS" will award four scholarships each scholarship will be funded in the total amount of 1.500€.</p>
  <div class="infoBox">
  <h2>Soon we will continue</h2>
  <p>We are currently organising the funding for the next round. This may take a few more days. Subscribe to our newsletter, or send us an e-mail to be informed directly when it continues, or check back with us at a later date.</p>
  </div>
  ...
  <h2 class="text-primary text-center" id="bewerben">Get to know us</h2>
  <p class="section">
    Are you unsure whether the scholarship is right for you?
    Have we not been able to answer all your questions?
    Or are you interested in finding out who is behind the project?
    Then get to know us <a href="https://meet.ffmuc.net/ccs-info">online in a Jitsi video call</a>.
    Registration is not required. Feel free to drop by.
    The next dates are as follows:
    <div class="col-md-7">
      <ul>
        <li>Wednesday 05.03.2025 19:00 - 20:00</li>
        <li>Thursday 17.04.2025 19:00 - 20:00</li>
      </ul>
    </div>
  </p>
...
- You will write a master's or diploma thesis in the semester 2024/2025.Winter
  - The work period is between October 2024 and March 2025
