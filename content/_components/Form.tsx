export default ({ ...props }) => (
  <form method="POST" action="/api/form" class="section">
    ...
    <div class="row my-2">
      <div class="form-group col">
        <label for="thesisTask">
          Wie ist die Aufgabenstellung deiner Arbeit? max. 1000 Zeichen
        </label>
        <textarea
          type="text"
          class="form-control"
    ...
    <div class="row my-2">
      <div class="form-group col">
        <label for="reasonApplicationThesis">
          Warum passt deine Arbeit ins Thema? max. 1000 Zeichen
        </label>
        <textarea
          class="form-control"
    ...
    <div class="row my-2">
      <div class="form-group col">
        <label for="reasonApplicationPerson">
          Erzähl uns etwas über dich? max. 1000 Zeichen
        </label>
        <textarea
          class="form-control"
    ...
    <div class="row my-2">
      <div class="form-group col">
        <label for="captcha">
          Captcha: Aus welcher Stadt kommt der Chaostreff Flensburg e.V.?
        </label>
        <input
          type="text"
          class="form-control"
