  ...
  {page.data.results.map((page) => (
    <div class="blog-card">
      <div class="blog-image-container">
        <a href={page.url}><img src={page.img ? page.img : "/media/blog/ccs.png"} alt={page.alt} class="blog-image"/></a>
      </div>
      <div>
        <div class="blog-title-container">
          <a href={page.url} class="text-decoration-none"><h2 class="text-xl font-medium blog-title">{page.title}</h2></a>
          <span>
        ...
        <div class="blog-text-container">
          <p class="m-1">{page.excerpt}</p>
          <a href={page.url} class="blog-link">Weiterlesen</a>
        </div>
      </div>
    </div>
  ))}
