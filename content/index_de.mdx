...
<div class="homeContent">
  <h1 class="text-center" id="headline">Stipendien - 2024/2025.Winter</h1>
  ...
  <div class="infoBox">
  <h2>Bald geht es weiter</h2>
  <p>Aktuell organisieren wir die Finanzierung der nächsten Runde. Dies kann noch einige Tage dauern. Abonniere unseren Newsletter, oder sende uns eine e-Mail um direkt infomiert zu werden wenn es weiter geht, oder schaue zu einer spären Zeit noch Mal bei uns vorbei.</p>
  </div>
  ...
  <h2 class="text-primary text-center" id="bewerben">Lerne uns kennen</h2>
  <p class="section">
...
<div id="bewerben"></div>
<a
  href="https://bewerben.c3fl.de/#/?proposal=ccs-20242"
  target="blank"
...
- Du schreibst im 2024/2025.Winter eine Master- oder Diplomarbeit
